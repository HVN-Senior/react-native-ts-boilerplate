...
const register = async (payload: RegisterPayload): Promise<AppResponse<RegisterResponse>> => {
  const response = await axiosInstance.post(`${API_ENDPOINT}/v1/auth/register`, payload);
