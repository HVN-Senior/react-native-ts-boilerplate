...
function CustomImage(props: Readonly<CustomImageProps>): React.JSX.Element {
  ...
  const [source, setSource] = useState<ImageSourcePropType>(require("@/assets/images/broken-image.png"));
  ...
  if (!imageSource) {
    return <Image source={require("@/assets/images/broken-image.png")} style={[styles.image, style]} />;
  }
